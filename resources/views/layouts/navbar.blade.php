<!-- navigator -->
<nav class="navbar navbar-expand-lg bg-primary m-0 mb-1" data-bs-theme="dark">
  <div class="container-fluid">
		<img
			src="{{ asset('report_4874366.png') }}"
      ...
      <ul class="navbar-nav mx-auto">
			...
			@if (Route::has('login'))
              ...
              {{ Auth::user()->belongstouser->name }}
				...
				@else
					<a class="btn btn-sm btn-secondary {{ (Route::has('register'))?'me-1':'me-5' }}" href="{{ route('login') }}">
						Sign in
					</a>
					@if (Route::has('register'))
						<a href="{{ route('register') }}" class="btn btn-sm btn-secondary me-5">
							Sign up
						</a>
					@endif
				@endauth
