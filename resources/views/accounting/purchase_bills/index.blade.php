...
<div class="card">
	<div class="card-header d-flex justify-content-between align-items-center">
		<h5><i class="fa fa-file-invoice-dollar"></i> Purchase Bills</h5>
		<a href="{{ route('accounting.purchase-bills.create') }}" class="btn btn-sm btn-primary">
			<i class="fa fa-plus"></i> New Purchase Bills
		</a>
	</div>
...
$('#salesInvoicesTable').DataTable({
	...
	columns: [
		...
		{ data: 'supplier_id', title: 'Supplier', defaultContent: '-' },
		...
		},
		{
			...
			render: function(id){
				return `
					<a href="{{ url('accounting/purchase-bills') }}/${id}" class="btn btn-sm btn-info"><i class="fa fa-eye"></i></a>
					<a href="{{ url('accounting/purchase-bills') }}/${id}/edit" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
