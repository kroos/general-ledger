...
@section('content')
<div class="col-sm-12">
	<form method="POST" action="{{ route('accounting.purchase-bills.update', $bill) }}" accept-charset="UTF-8" id="form" autocomplete="off" class="" enctype="multipart/form-data">
		@csrf
		@method('PATCH')
		<div class="card border-success">
			<div class="card-header bg-success text-white">
				<i class="fa fa-edit"></i> Edit Purchase Bills
			</div>

			<div class="card-body">
				@include('accounting.purchase_bills._form', ['bill' => $bill])
			</div>
			<div class="card-footer text-end">
				...
				<a href="{{ route('accounting.purchase-bills.index') }}" class="btn btn-secondary">Cancel</a>
			</div>
		</div>
	</form>
</div>
...
@php
	$items = $bill->items()->get(['account_id', 'description', 'quantity', 'unit_price', 'amount']);
