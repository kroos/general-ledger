...
@section('content')
<div class="col-sm-12">
	<form method="POST" action="{{ route('accounting.purchase-bills.store') }}" id="form" autocomplete="off">
		@csrf
		<div class="card border-success">
			<div class="card-header bg-success text-white">
				<i class="fa fa-file-invoice"></i> New Purchase Bills
			</div>

			<div class="card-body">
				@include('accounting.purchase_bills._form')
			</div>
			<div class="card-footer text-end">
				<button type="submit" class="btn btn-secondary"><i class="fa fa-save" name="action" value="draft"></i> Save Draft</button>
